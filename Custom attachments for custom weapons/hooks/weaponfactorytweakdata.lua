	...
	if type(attach_tables[sight_base]) == "table" then
		if self[wpn_id] then
			for i, sight_id in pairs(attach_tables[sight_base]) do
				...
				if switch_id then
					if sight_id == "wpn_fps_upg_o_acog_rmr" or "wpn_fps_upg_o_ta648rmr" or "wpn_fps_upg_o_su230_mdrs" or "wpn_fps_upg_o_mark4_hamr" or "wpn_fps_upg_o_acog_ta01nsn_iron" then
...
if self.wpn_fps_ass_arn87 then
	...
	self:cafcw_add_attachment_type("Gadgets", "wpn_fps_ass_arn87")
end
-- Secondary
-- PPSh-41
