...
--		self:cafcw_add_custom_sights_custom("specter", "wpn_fps_ass_fortress", "wpn_fps_ass_famas", "0,2,-3")
--		self:cafcw_add_custom_sights_custom("acog", "wpn_fps_ass_fortress", "wpn_fps_ass_famas", "0,8,-3")
		self:cafcw_add_custom_sights_custom("specter", "wpn_fps_ass_fortress", "wpn_fps_ass_famas", "0,2,-2.96")
		self:cafcw_add_custom_sights_custom("acog", "wpn_fps_ass_fortress", "wpn_fps_ass_famas", "-0.01,8,-2.96")	
		self:cafcw_add_custom_sights_custom("rds45", "wpn_fps_ass_fortress", "wpn_fps_ass_famas", "2.9,-7,-14")
	end
