...
if self.wpn_fps_snp_b42 then
	...
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_dd_a1_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_kac_rear", "0,-10,-4.2")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_mbus_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_m4flipup_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_scorpionevo_rear", "0,-10,-1.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_troy_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_troym4_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_cheap_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_dh_iss_rear", "0,-10,-3.53")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_mbuspro_rear", "0,-10,-3.7")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_snp_b42", "wpn_fps_upg_o_snp_scalarworks_peak_rear", "0,-10,-3.7")
