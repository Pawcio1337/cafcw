...
if self.wpn_fps_pis_swmp40 then
	...
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_dot", "wpn_fps_upg_fl_unimax", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_ghostring", "wpn_fps_upg_fl_unimax", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_pro", "wpn_fps_upg_fl_unimax", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_xs", "wpn_fps_upg_fl_unimax", "a_fl_vanilia")
	...
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_dot", "wpn_fps_upg_fl_utg_pis", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_ghostring", "wpn_fps_upg_fl_utg_pis", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_pro", "wpn_fps_upg_fl_utg_pis", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_xs", "wpn_fps_upg_fl_utg_pis", "a_fl_vanilia")
