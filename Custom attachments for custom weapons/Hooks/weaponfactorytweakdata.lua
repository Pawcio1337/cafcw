...
attach_tables.AR15_Stocks_MK12 = {
	"wpn_fps_upg_m4_s_caastock",
	"wpn_fps_upg_m4_s_caastock_black",
	"wpn_fps_upg_m4_s_hke1",
	"wpn_fps_upg_m4_s_collapsed",
...
attach_tables.AR15_Stocks_R0933BLK = {
	"wpn_fps_upg_m4_s_caastock",
	"wpn_fps_upg_m4_s_caastock_black",
	"wpn_fps_upg_m4_s_hke1",
	"wpn_fps_upg_m4_s_collapsed",
...
attach_tables.AR15_Stocks_SR3M = {
	"wpn_fps_upg_m4_s_caastock",
	"wpn_fps_upg_m4_s_hke1",
	"wpn_fps_upg_m4_s_viper",
	"wpn_fps_upg_m4_s_collapsed",
...
attach_tables.AR15_Stocks_PLR16 = {
	"wpn_fps_upg_m4_s_caastock",
	"wpn_fps_upg_m4_s_caastock_black",
	"wpn_fps_upg_m4_s_hke1"
}
...
-- Unique weapon tables to exclude specific sights.
...
sight_tables.custom_sniper_sv98 = {
	...
	for i, sight_id in pairs(sight_tables[sight_base]) do
		...
		if self.parts[a_obj_part_id] and a_obj_id then
			if self.parts[a_obj_part_id].override then
				self.parts[a_obj_part_id].override[sight_id] = {a_obj = a_obj_id}
			else
				log("[ERROR] CAFCW: Missing override table: " .. wpn_id, sight_id, a_obj_part_id, a_obj_id)
			end
		end
	end
end
function WeaponFactoryTweakData:cafcw_add_attachment_type(attach_type, wpn_id, add_id)
	if type(attach_tables[attach_type]) == "table" then
		...
		log("[ERROR] cafcw_forbids_attachment_type: Incorrect attach_type used: " .. attach_type, wpn_id, add_id)
	end
end
function WeaponFactoryTweakData:cafcw_forbids_attachment_type(attach_type, attach_id)
	if type(attach_tables[attach_type]) == "table" then
		...
		log("[ERROR] cafcw_forbids_attachment_type: Incorrect attach_type used: " .. attach_type, attach_id)
	end
end
function WeaponFactoryTweakData:cafcw_part_a_obj_pattern_override(attach_type, part_ovr_id, a_obj_id, parent_id)
	if type(attach_tables[attach_type]) == "table" then
		...
		log("[ERROR] cafcw_part_a_obj_pattern_override: Incorrect attach_type used: " .. attach_type, part_ovr_id)
	end
end
...
if self.wpn_fps_ass_ak12 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_ak12")
end
-- M40A5
...
if self.wpn_fps_ass_sr3m then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_sr3m", "wpn_fps_ass_amcar", "wpn_fps_ass_sr3m_scopemount", "wpn_fps_upg_sr3m_cover_rail", "a_o_railcover")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_sr3m", "wpn_fps_ass_amcar", "wpn_fps_ass_sr3m_scopemount", "wpn_fps_upg_sr3m_cover_rail", "a_o_railcover")
	self:cafcw_add_custom_sights("custom", "wpn_fps_ass_sr3m", "wpn_fps_ass_amcar", "wpn_fps_ass_sr3m_scopemount", "wpn_fps_upg_sr3m_cover_rail", "a_o_railcover")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_sr3m")
...
if self.wpn_fps_ass_g36k then
	...
	self:cafcw_add_to_parts("sight", "wpn_fps_ass_g36k", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_ass_g36")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_g36k")
end
-- SKS
if self.wpn_fps_ass_sks then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_sks")
end
-- FN F2000 Tactical
if self.wpn_fps_ass_f2000 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_f2000")
end
-- AK12-76
if self.wpn_fps_shot_ak12_76 then
	...
	self:cafcw_add_attachment_type("Suppresssors_Shotgun", "wpn_fps_shot_ak12_76")
end
-- SV-98
...
if self.wpn_fps_ass_aku94 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_aku94")
...
if self.wpn_fps_ass_rk62 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_rk62", "wpn_fps_ass_akm", "wpn_fps_ass_rk62_rail", "wpn_fps_upg_rk62_handguard_railed", "a_o_railed")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_rk62", "wpn_fps_ass_akm", "wpn_fps_ass_rk62_rail", "wpn_fps_upg_rk62_handguard_railed", "a_o_railed")
	self:cafcw_add_custom_sights("custom", "wpn_fps_ass_rk62", "wpn_fps_ass_akm", "wpn_fps_ass_rk62_rail", "wpn_fps_upg_rk62_handguard_railed", "a_o_railed")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_rk62")
...
if self.wpn_fps_ass_r0991 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_r0991")
	self:cafcw_forbids_attachment_type("Barrel_Extensions", "wpn_fps_upg_r0991_barrel_supp")
	self:cafcw_forbids_attachment_type("Suppresssors", "wpn_fps_upg_r0991_barrel_supp")
end
-- SA vz. 58P
if self.wpn_fps_ass_vz58 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_vz58")
...
if self.wpn_fps_ass_ots_14_4a then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_ots_14_4a", "wpn_fps_ass_l85a2", "wpn_fps_ass_ots_14_4a_sight_rail", "wpn_fps_upg_ots_14_4a_handle_rail", "a_o_handle")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_ots_14_4a", "wpn_fps_ass_l85a2", "wpn_fps_ass_ots_14_4a_sight_rail", "wpn_fps_upg_ots_14_4a_handle_rail", "a_o_handle")
	self:cafcw_add_custom_sights("custom", "wpn_fps_ass_ots_14_4a", "wpn_fps_ass_l85a2", "wpn_fps_ass_ots_14_4a_sight_rail", "wpn_fps_upg_ots_14_4a_handle_rail", "a_o_handle")
...
if self.wpn_fps_ass_scar_m203 then
	...
	self:cafcw_add_to_parts("sight_rail", "wpn_fps_ass_scar_m203", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_ass_contraband", "wpn_fps_ass_scar_m203_irons_front")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_scar_m203")
...
if self.wpn_fps_ass_xm8 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_xm8")
end
-- Galil ACE 23
if self.wpn_fps_ass_galilace then
	...
	self:cafcw_add_to_parts("sight", "wpn_fps_ass_galilace", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_smg_hajk")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_galilace")
...
if self.wpn_fps_ass_galilace_762 then
	...
	self:cafcw_add_to_parts("sight", "wpn_fps_ass_galilace_762", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_smg_hajk")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_galilace_762")
end
-- AEK-971
...
if self.wpn_fps_ass_aek971 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_aek971")
...
if self.wpn_fps_ass_a545 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_a545")
end
-- Baikal MP-153
if self.wpn_fps_shot_mp153 then
	...
	self:cafcw_add_attachment_type("Suppresssors_Shotgun", "wpn_fps_shot_mp153")
end
-- Akimbo Sidekick
...
if self.wpn_fps_lmg_rpd then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_rpd")
end
-- M60
...
--
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_m60")
end
-- Ohio Ordnance HCAR
if self.wpn_fps_ass_hcar then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_hcar")
...
if self.wpn_fps_ass_hk416 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_hk416")
end
-- SVD
...
if self.wpn_fps_ass_scarl then
	...
	self:cafcw_add_to_parts("sight_rail", "wpn_fps_ass_scarl", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_ass_m4", "wpn_fps_ass_scarl_ironsights_front_fold")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_scarl")
...
if self.wpn_fps_ass_x95 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_x95", "wpn_fps_ass_x95_rm55")
end
...
if self.wpn_fps_lmg_lsat then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_lsat")
end
-- Molot Vepr-12
if self.wpn_fps_shot_vepr12 then
	...
	self:cafcw_add_attachment_type("Suppresssors_Shotgun", "wpn_fps_shot_vepr12")
...
if self.wpn_fps_ass_mdr then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_mdr")
...
if self.wpn_fps_ass_sar21 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_sar21")
...
if self.wpn_fps_shot_x_jackhammer then
	...
	self:cafcw_add_attachment_type("Suppresssors_Shotgun", "wpn_fps_shot_x_jackhammer")
	self:cafcw_forbids_attachment_type("Suppresssors_Shotgun", "wpn_fps_shot_jackhammer_barrel")
	self:cafcw_forbids_attachment_type("Suppresssors_Shotgun", "wpn_fps_upg_jackhammer_barrel_supp")
end
-- Akimbo Magpul FMG-9
if self.wpn_fps_smg_x_fmg9 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_x_fmg9")
end
-- Akimbo APS
if self.wpn_fps_x_aps then
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_x_aps", "wpn_fps_pis_aps_rail")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_x_aps")
end
-- Akimbo HK45C
if self.wpn_fps_x_hk45c then
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_x_hk45c")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_x_hk45c")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_x_hk45c", "a_ns", "barrel")
end
-- ASh-12.7
...
if self.wpn_fps_lmg_ultimax then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_ultimax")
end
-- Browning M1919A6
if self.wpn_fps_lmg_m1919a6 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_m1919a6")
...
if self.wpn_fps_ass_ar18 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_ar18")
end
-- TOZ-34
...
if self.wpn_fps_ass_g3m203 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_g3m203", "wpn_fps_ass_g3", "wpn_fps_ass_g3m203_sightrail", "wpn_fps_upg_g3m203_sight_mount_claw", "a_o_claw")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_g3m203", "wpn_fps_ass_g3", "wpn_fps_ass_g3m203_sightrail", "wpn_fps_upg_g3m203_sight_mount_claw", "a_o_claw")
	self:cafcw_add_custom_sights("custom_g3m203", "wpn_fps_ass_g3m203", "wpn_fps_ass_g3", "wpn_fps_ass_g3m203_sightrail", "wpn_fps_upg_g3m203_sight_mount_claw", "a_o_claw")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_g3m203")
...
if self.wpn_fps_lmg_mg4 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_mg4")
end
-- HK PSG-1
...
if self.wpn_fps_lmg_lewis then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_lewis")
end
-- Caulk n' Burn
...
if self.wpn_fps_ass_obr5 then
	...
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_dd_a1_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_kac_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_m4flipup_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_mbus_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_scorpionevo_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_troy_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_long", "wpn_fps_upg_o_var_troym4_front", "a_of_long")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_dd_a1_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_kac_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_m4flipup_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_mbus_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_scorpionevo_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_troy_front", "a_of_short")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_obr5_handguard_short", "wpn_fps_upg_o_var_troym4_front", "a_of_short")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_dd_a1_rear")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_kac_rear")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_m4flipup_rear")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_mbus_rear")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_scorpionevo_rear")
	self:cafcw_add_to_parts("forbids_add", "wpn_fps_upg_obr5_gadgets_top", "wpn_fps_upg_o_var_troym4_rear")
...
if self.wpn_fps_smg_mpx then
	...
	self:cafcw_add_to_parts("sight", "wpn_fps_smg_mpx", "wpn_fps_upg_o_var_dd_a1_rear", "wpn_fps_smg_mpx_troy", "wpn_fps_smg_mpx")
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_mpx")
	self:cafcw_forbids_attachment_type("Barrel_Extensions", "wpn_fps_upg_mpx_barrel_sd")
	self:cafcw_forbids_attachment_type("Suppresssors", "wpn_fps_upg_mpx_barrel_sd")
end
-- PPSh-41
if self.wpn_fps_smg_ppsh then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_ppsh")
	self:cafcw_forbids_attachment_type("Barrel_Extensions", "wpn_fps_smg_ppsh_barrel")
	self:cafcw_forbids_attachment_type("Suppresssors", "wpn_fps_smg_ppsh_barrel")
end
-- CBJ-MS
if self.wpn_fps_smg_cbjms then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_cbjms")
end
...
if self.wpn_fps_smg_vityaz then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_vityaz")
...
if self.wpn_fps_pis_aps then
	...
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_aps")
end
-- S&W M&P40
if self.wpn_fps_pis_swmp40 then
	...
	self:cafcw_add_to_parts("wpn_parent_ovr", "wpn_fps_pis_swmp40", "wpn_fps_upg_o_deltapoint_pro", "slide")
end
-- AP Pistol
if self.wpn_fps_pis_appistol then
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_pis_appistol")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_appistol")
end
-- Duke 1911
if self.wpn_fps_pis_duke1911 then
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_pis_duke1911")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_duke1911")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_duke1911", "a_ns", "barrel")
end
-- Beretta 93R
if self.wpn_fps_pis_b93r then
	...
	self:cafcw_add_to_parts("wpn_parent_ovr", "wpn_fps_pis_b93r", "wpn_fps_upg_o_deltapoint_pro", "slide")
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_pis_b93r")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_b93r")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_b93r", nil, "barrel")
end
-- Walther P99
if self.wpn_fps_pis_p99 then
	...
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_p99")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_p99", "a_ns", "barrel")
end
-- HK45C
if self.wpn_fps_pis_hk45c then
	...
	self:cafcw_add_to_parts("wpn_parent_ovr", "wpn_fps_pis_hk45c", "wpn_fps_upg_o_deltapoint_pro", "slide")
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_pis_hk45c")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_hk45c")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_hk45c", "a_ns", "barrel")
end
-- Steyr AUG A3 9mm XS
if self.wpn_fps_smg_aug9mm then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_aug9mm", "wpn_fps_smg_aug9mm_gadget_rm55")
...
if self.wpn_fps_pis_m712 then
	...
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_m712")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_m712", "a_ns", "barrel")
end
-- Beretta Px4 Storm
if self.wpn_fps_pis_px4 then
	...
	self:cafcw_add_to_parts("wpn_parent_ovr", "wpn_fps_pis_px4", "wpn_fps_upg_o_deltapoint_pro", "slide")
	self:cafcw_add_attachment_type("Gadgets_Pistol", "wpn_fps_pis_px4")
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_px4")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_px4", "a_ns", "barrel")
end
-- PPS-43
if self.wpn_fps_smg_pps43 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_pps43")
end
-- Chiappa Rhino 60DS
if self.wpn_fps_pis_rhino then
	...
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_rhino_frame_200ds", "wpn_fps_upg_fl_utg_pis", "a_fl_200ds")
...
if self.wpn_fps_pis_zenith then
	...
	self:cafcw_add_attachment_type("Suppresssors_Pistol", "wpn_fps_pis_zenith")
	self:cafcw_wpn_a_obj_pattern_override("Suppresssors_Pistol", "wpn_fps_pis_zenith", "a_ns", "barrel")
end
-- Lahti L-35
...
if self.wpn_fps_pis_plr16 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_pis_plr16")
...
if self.wpn_fps_smg_coltsmg then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_coltsmg")
end
-- Mosin Nagant M9130 Obrez
if self.wpn_fps_snp_obrez then
-- TODO PU Scope update
...
if self.wpn_fps_ass_skspug then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_skspug")
end
-- SA vz. 58 Compact
if self.wpn_fps_smg_vz58comp then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_vz58comp")
end
-- Einhänder
...
if self.wpn_fps_shot_ks23 then
	...
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_obr5", "wpn_fps_snp_tti")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_smg_vz58comp", "wpn_fps_ass_74")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_l1a1", "wpn_fps_ass_fal")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_sg552", "wpn_fps_ass_s552")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_lkrifle", "wpn_fps_smg_hajk")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_bulldoge", "wpn_fps_ass_l85a2")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_gcar", "wpn_fps_ass_tecci")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_vsk94", "wpn_fps_ass_ak5")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_acw", "wpn_fps_ass_ak5")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_smg_evo", "wpn_fps_smg_schakal")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_ak556", "wpn_fps_ass_ak5")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_smg_kedr", "wpn_fps_smg_tec9")
end
...
if self.parts.wpn_fps_upg_o_ta648rmr and self.parts.wpn_fps_upg_o_ta648rmr_switch then
	...
	self:cafcw_acogrmr_stance("ta648", "wpn_fps_ass_obr5", "wpn_fps_snp_tti")
end
-- AK Rail Cover
