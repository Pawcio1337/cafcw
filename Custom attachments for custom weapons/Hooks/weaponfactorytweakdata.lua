...
sight_tables.custom_sniper_sv98 = {
	...
	for i, sight_id in ipairs(sight_tables[sight_base]) do
...
if self.wpn_fps_ass_sr3m then
	...
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_ass_sr3m", "wpn_fps_upg_o_eotech552", "0,10,-6.145")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_sr3m_cover_rail", "wpn_fps_upg_o_eotech552", "a_o_railcover")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_ass_sr3m", "wpn_fps_upg_o_st10", "0,10,-6.48")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_sr3m_cover_rail", "wpn_fps_upg_o_st10", "a_o_railcover")
	self:cafcw_add_to_parts("sight_vector", "wpn_fps_ass_sr3m", "wpn_fps_upg_o_visionking", "0,10,-6.48")
...
if self.wpn_fps_ass_sks then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_sks", "wpn_fps_snp_siltstone", "wpn_fps_ass_sks_molot_mount")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_sks", "wpn_fps_snp_siltstone", "wpn_fps_ass_sks_molot_mount")
	self:cafcw_add_custom_sights("custom", "wpn_fps_ass_sks", "wpn_fps_snp_siltstone", "wpn_fps_ass_sks_molot_mount")
	self:cafcw_add_custom_sights("rds45", "wpn_fps_ass_sks", "wpn_fps_snp_siltstone")
end
-- FN F2000 Tactical
...
if self.wpn_fps_snp_sv98 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
	self:cafcw_add_custom_sights("acog", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
	self:cafcw_add_custom_sights("custom", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
	self:cafcw_add_custom_sights("shortdot", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
	self:cafcw_add_custom_sights("custom_sniper_sv98", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
	self:cafcw_add_custom_sights("rds45", "wpn_fps_snp_sv98", "wpn_fps_snp_model70")
end
-- AKU-94
...
-- Valmet Rk.62
-- Specter stance_mod: 0, 9, -3.9
-- Acog stance_mod: 0, 15, -3.9
if self.wpn_fps_ass_rk62 then
	...
	self:cafcw_add_to_parts("sight_vector_rail", "wpn_fps_ass_rk62", "wpn_fps_upg_o_susat", "0,15,-5.655", "wpn_fps_ass_rk62_rail")
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_rk62", "wpn_fps_ass_rk62", "wpn_fps_ass_rk62_rail")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_rk62", "wpn_fps_ass_rk62", "wpn_fps_ass_rk62_rail")
	self:cafcw_add_custom_sights("rds45", "wpn_fps_ass_rk62", "wpn_fps_ass_rk62")
	self:cafcw_add_to_parts("sight_vector_rail", "wpn_fps_ass_rk62", "wpn_fps_upg_o_compm2", "0,9,-3.25", "wpn_fps_ass_rk62_rail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_rk62_handguard_railed", "wpn_fps_upg_o_compm2", "a_o_railed")
end
-- VSS
-- Specter stance_mod: 0, 10, -6.48
-- Acog stance_mod: 0, 14, -6.48
...
-- AEK-971
-- Specter stance_mod: 0, 3, -4.6
-- Acog stance_mod: 0, 9, -4.6
if self.wpn_fps_ass_aek971 then
	...
	self:cafcw_add_to_parts("sight_vector_rail", "wpn_fps_ass_aek971", "wpn_fps_upg_o_susat", "0,9,-6.355", "wpn_fps_ass_aek971_mtk8")
...
-- XM21
-- Specter stance_mod: -0.03, 0, -5.21
-- Acog stance_mod: -0.03, 6, -5.21
-- Shortdot stance_mod: -0.02, -25, -5.97
if self.wpn_fps_snp_xm21 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21_scope_mount")
	self:cafcw_add_custom_sights("acog", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21_scope_mount")
	self:cafcw_add_custom_sights("shortdot", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21", "wpn_fps_snp_xm21_scope_mount")
	self:cafcw_add_custom_sights("rds45", "wpn_fps_snp_xm21", "wpn_fps_ass_m14", "wpn_fps_snp_xm21_offset_sight_rail")
end
-- Arisaka Type 38
...
if self.wpn_fps_smg_fmg9 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_smg_fmg9", "wpn_fps_smg_fmg9")
	self:cafcw_add_custom_sights("acog", "wpn_fps_smg_fmg9", "wpn_fps_smg_fmg9")
end
-- PP-19-01 Vityaz
...
if self.wpn_fps_pis_swmp40 then
	...
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_pis_swmp40_sight_rear", "wpn_fps_upg_fl_unimax", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_dot", "wpn_fps_upg_fl_unimax", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_ghostring", "wpn_fps_upg_fl_unimax", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_pro", "wpn_fps_upg_fl_unimax", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_xs", "wpn_fps_upg_fl_unimax", "a_fl_leftrail")
	self:cafcw_add_to_parts("gadget", "wpn_fps_pis_swmp40", "wpn_fps_upg_fl_utg_pis")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_pis_swmp40_sight_rear", "wpn_fps_upg_fl_utg_pis", "a_fl_vanilia")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_dot", "wpn_fps_upg_fl_utg_pis", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_ghostring", "wpn_fps_upg_fl_utg_pis", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_pro", "wpn_fps_upg_fl_utg_pis", "a_fl_leftrail")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_upg_swmp40_sight_xs", "wpn_fps_upg_fl_utg_pis", "a_fl_leftrail")
