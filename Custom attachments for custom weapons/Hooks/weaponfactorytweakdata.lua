...
if self.parts.wpn_fps_upg_o_acog_rmr and self.parts.wpn_fps_upg_o_acog_rmr_switch then
	...
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_snp_xm21", "wpn_fps_ass_m14")
...
if self.wpn_fps_ass_qbz3 then
	...
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_saigry", "wpn_fps_ass_m4")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_smg_mp7new", "wpn_fps_smg_mp9")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_hugsforleon", "wpn_fps_ass_m16")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_op68", "wpn_fps_ass_m4")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_smg_czevo", "wpn_fps_smg_shepheard")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_fortress", "wpn_fps_ass_famas")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_sho_dp12", "wpn_fps_sho_ksg")
	self:cafcw_acogrmr_stance("ta31f", "wpn_fps_ass_bren2", "wpn_fps_ass_m4")
...
if self.parts.wpn_fps_upg_o_ta648rmr and self.parts.wpn_fps_upg_o_ta648rmr_switch then
	...
	self:cafcw_acogrmr_stance("ta648", "wpn_fps_snp_kozak", "wpn_fps_snp_tti")
end
-- AK Rail Cover
