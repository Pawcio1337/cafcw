...
if self.wpn_fps_smg_spectre_m4 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_spectre_m4")
end
if self.wpn_fps_smg_x_spectre_m4 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_x_spectre_m4")
end

--TOZ-194
if self.wpn_fps_shot_toz194 then
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_ass_spotter")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_shot_toz194_fb_short", "wpn_fps_upg_fl_ass_spotter", "a_sfl")
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_wml")
	...
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_anpeq2")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_shot_toz194_fb_short", "wpn_fps_upg_fl_anpeq2", "a_sfl")
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_dbal_d2")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_shot_toz194_fb_short", "wpn_fps_upg_fl_dbal_d2", "a_sfl")
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_m600p")
	self:cafcw_add_to_parts("part_a_obj_ovr", "wpn_fps_shot_toz194_fb_short", "wpn_fps_upg_fl_m600p", "a_sfl")
	self:cafcw_add_to_parts("gadget", "wpn_fps_shot_toz194", "wpn_fps_upg_fl_utg")
...
if self.wpn_fps_ass_qbz95 and self.parts.wpn_fps_ass_qbz95_fg_rails then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_qbz95")
    end
...
if self.wpn_fps_ass_stg44 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_stg44")
    end
...
if self.wpn_fps_ass_qbz3 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_qbz3")
    end
...
if self.wpn_fps_smg_m3 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_m3")
    end
if self.wpn_fps_smg_x_m3 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_x_m3")
end
...
if self.wpn_fps_shot_x_aa12 then
	...
	self:cafcw_add_custom_ammo("wpn_fps_shot_x_aa12", "_12ga_auto")
end
...
if self.wpn_fps_shot_x_striker then
	...
	self:cafcw_add_custom_ammo("wpn_fps_shot_x_striker", "_12ga_auto")
end
...
if self.wpn_fps_ass_ar60mrks then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_ar60mrks")
end
if self.wpn_fps_ass_x_ar60mrks then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_ass_x_ar60mrks")
end
--MG 34
if self.wpn_fps_lmg_mg34 then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_lmg_mg34")
end
--Owen Gun
if self.wpn_fps_smg_owen then
	...
	self:cafcw_add_attachment_type("Suppresssors", "wpn_fps_smg_owen")
end
...
if self.wpn_fps_shot_toz106 then
	...
	self:cafcw_add_custom_ammo("wpn_fps_shot_toz106", "_12ga_auto")
