...
if self.wpn_fps_ass_vsk94 then
	...
	self:cafcw_add_custom_sights("specter", "wpn_fps_ass_vsk94", "wpn_fps_ass_ak5", nil, "0,4,-4.1")
	self:cafcw_add_custom_sights("acog", "wpn_fps_ass_vsk94", "wpn_fps_ass_ak5", nil, "0,4,-4.1")
	self:cafcw_add_custom_sights("custom", "wpn_fps_ass_vsk94", "wpn_fps_ass_ak5", nil, "0,4,-0.6")
--	self:cafcw_add_custom_sights("rds45", "wpn_fps_ass_vsk94", "wpn_fps_ass_tecci", nil, "-3.9,22,-10.3")
end
-- 9A-91 old
