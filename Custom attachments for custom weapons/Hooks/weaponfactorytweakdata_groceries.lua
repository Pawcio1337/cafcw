...
if self.wpn_fps_ass_tilt then
	...
	self:cafcw_add_to_parts("barrel_ext", "wpn_fps_ass_tilt", "wpn_fps_ass_ns_g_sup3")
	self:cafcw_add_to_parts("barrel_ext", "wpn_fps_ass_tilt", "wpn_fps_ass_ns_g_sup4")
...
if self.wpn_fps_smg_pdr then
	...
	self:cafcw_add_to_parts("other", "wpn_fps_smg_pdr", "wpn_fps_riflein556")
	self:cafcw_add_to_parts("other", "wpn_fps_smg_pdr", "wpn_fps_upg_a_taser556")
