...
if self.wpn_fps_smg_ump then
	...
	self:cafcw_add_generic_custom_sights("specter", "wpn_fps_smg_ump", "wpn_fps_smg_mp5")
	self:cafcw_add_generic_custom_sights("acog", "wpn_fps_smg_ump", "wpn_fps_smg_mp5")
end
-- Montana 5.56
if self.wpn_fps_ass_yayo then
	...
	self:cafcw_add_generic_custom_sights("specter", "wpn_fps_ass_yayo", "wpn_fps_ass_contraband")
	self:cafcw_add_generic_custom_sights("acog", "wpn_fps_ass_yayo", "wpn_fps_ass_contraband")
end
end)