...
if self.parts.wpn_fps_upg_o_delta_rm55 then
table.insert(self.wpn_fps_shot_m1216.uses_parts, "wpn_fps_upg_o_delta_rm55")
	self.wpn_fps_shot_m1216.adds.wpn_fps_upg_o_delta_rm55 = {
		"wpn_fps_shot_m1216_irons_front_folded",
		"wpn_fps_shot_m1216_o_adjust"
	}
	self.parts.wpn_fps_upg_o_delta_rm55.stance_mod.wpn_fps_shot_m1216 = deep_clone(self.parts.wpn_fps_upg_o_45rds.stance_mod.wpn_fps_smg_coal)
end
if self.parts.wpn_fps_upg_o_horzine then
