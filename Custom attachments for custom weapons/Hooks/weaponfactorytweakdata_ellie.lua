...
if self.wpn_fps_snp_fyjs then
	...
	self:cafcw_add_generic_custom_sights("specter", "wpn_fps_snp_fyjs", "wpn_fps_snp_msr")
	self:cafcw_add_generic_custom_sights("acog", "wpn_fps_snp_fyjs", "wpn_fps_snp_msr")
-- Update v1.68.199
...
if self.wpn_fps_ass_ar160 then
	...
	self:cafcw_add_generic_custom_sights("specter", "wpn_fps_ass_ar160", "wpn_fps_ass_amcar")
	self:cafcw_add_generic_custom_sights("acog", "wpn_fps_ass_ar160", "wpn_fps_ass_amcar")
	-- Update v1.68.199
