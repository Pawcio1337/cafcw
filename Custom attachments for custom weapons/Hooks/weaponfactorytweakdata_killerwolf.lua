...
if self.wpn_fps_lmg_dp28 then
	...
	self:cafcw_add_custom_sights_custom("specter", "wpn_fps_lmg_dp28", "wpn_fps_lmg_mg42", "0, 10, -4", "wpn_fps_lmg_dp28_rail_sight", "wpn_fps_lmg_dp28_ro_rail")
	self:cafcw_add_custom_sights_custom("acog", "wpn_fps_lmg_dp28", "wpn_fps_lmg_mg42", "0, 10, -4", "wpn_fps_lmg_dp28_rail_sight", "wpn_fps_lmg_dp28_ro_rail")	
...
if self.wpn_fps_sho_dp12 then
	...
	self:cafcw_add_custom_sights_custom("specter", "wpn_fps_sho_dp12", "wpn_fps_sho_ksg", "0, 0, -0.38")
	self:cafcw_add_custom_sights_custom("acog", "wpn_fps_sho_dp12", "wpn_fps_sho_ksg", "0, 3, -0.38")
	self:cafcw_add_custom_sights_custom("custom", "wpn_fps_sho_dp12", "wpn_fps_sho_ksg", "0,0,0.92")
	self:cafcw_add_custom_sights_custom("rds45", "wpn_fps_sho_dp12", "wpn_fps_sho_ksg", "-3.1, -2, -8.24")
